...
//        } catch (Exception e) {
//            response = mapToApiResponse(HttpStatus.INTERNAL_SERVER_ERROR.value(), false, "Failed to register user", null);
...
//            var token = tokenProvider.generateAccessToken((User) authUser.getPrincipal());
//
//            var jwt = new LoginResponse();
//            jwt.setToken(token);
//            jwt.setUser(mapUserToDTO((User) authUser.getPrincipal()));
//
